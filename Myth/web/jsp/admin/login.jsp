	...
	<div class="panel-body">
		<form action="${pageContext.request.contextPath }/adminLogin" method="post">
			<div class="form-group">
				<label>用户名:</label>
				<input type="text" name="name" id="" class="form-control" placeholder="请输入用户名……"/>
			</div>
			<div class="form-group">
				<label>密&nbsp;&nbsp;&nbsp;码:</label>
			...
			<div class="row">
				<center><input type="reset" value="${loginMsg}" class="btn btn-default "></center>
			</div>
		</form>
	</div>
</div>
