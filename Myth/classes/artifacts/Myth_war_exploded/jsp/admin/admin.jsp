...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand">MYTH后台管理</a>
		</div>
		...
		<div id="left_tab" style="margin-top: 70px;" class="collapse navbar-default navbar-collapse">
			<ul class="nav panel-group" id="myPanel">
				...
				<li class="panel">
					<a href="#sub2" data-toggle="collapse" data-parent="#myPanel"> 评论管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub2" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showComment">
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看游戏评论
							</a>
						</li>
					</ul>
				</li>
				<li class="panel">
					<a href="#sub3" data-toggle="collapse" data-parent="#myPanel"> 游戏管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub3" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showGames" >
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看游戏
							</a>
						</li>
						<li>
							<a href="#" id="addGames">
								<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;添加游戏
							</a>
						</li>
					</ul>
				</li>
				<li class="panel">
					<a href="#sub5" data-toggle="collapse" data-parent="#myPanel"> 购物车管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub5" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showCart">
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看购物车
							</a>
						</li>
					</ul>
				</li>
				<li class="panel">
					<a href="#sub6" data-toggle="collapse" data-parent="#myPanel"> 仓库管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub6" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showWareHouse">
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看仓库
							</a>
						</li>
					</ul>
				</li>
		...
		<div class="page_main">
			<script type="text/javascript">
				$("#showUser").click(function(){
					$(".dv_content").attr("src","jsp/admin/userList.jsp");
				})
				$("#showComment").click(function(){
					$(".dv_content").attr("src","jsp/admin/showcomment.jsp");
				})
				$("#showGames").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/getGamesList");
				})
				$("#addGames").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/toAddGames");
				})
				$("#showCart").click(function(){
					$(".dv_content").attr("src","jsp/admin/showcart.jsp");
				})
				$("#showWareHouse").click(function(){
					$(".dv_content").attr("src","jsp/admin/showwarehouse.jsp");
				})
			</script>
